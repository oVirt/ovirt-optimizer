...
public class ScoreOnlySolver {
    private static final Logger log = LoggerFactory.getLogger(ScoreOnlySolver.class);

    // Cache for the score only solver
    private static List<File> recordedCustomDrlFiles = null;
     ...
     */
    private static Solver getScoreOnlySolver(List<File> customDrlFiles) {
